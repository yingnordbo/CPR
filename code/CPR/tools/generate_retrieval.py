...
from dataset import DATASET_INFOS, test_transform, read_image, register_custom_dataset
...
if __name__ == "__main__":
    ...
    # data
    parser.add_argument("--dataset-name", type=str, default="mvtec", choices=["mvtec", "mvtec_3d", "btad", "custom"], help="dataset name")
